...
const KNOWN_ESP_DOMAINS = [
    // Constant Contact (includes legacy rs6.net sending domain)
    'ccsend.com', 'rs6.net',
    // Mailchimp / Intuit
...
const ESP_SENDER_DOMAINS = new Set([
    ...
    'mailchimp.com', 'cmail20.com', 'rsgsv.net', 'mandrillapp.com',
    ...
    'pardot.com',
    'mailgun.org', 'mailgun.net',
    'constantcontact.com', 'ccsend.com', 'rs6.net',
...
const PROTECTED_COMMON_WORD_BRANDS = new Set([
    ...
    'free', 'next', 'noon', 'shell', 'gap', 'square'
]);
...
const BRAND_CONTENT_DETECTION = {
    ...
    'morgan stanley': {
        ...
        legitimateDomains: ['morganstanley.com', 'ms.com', 'etrade.com', 'etradefinancial.com']
    },
    'wise': {
    ...
    'hilton': { keywords: ['hilton', 'hilton honors', 'hilton garden'], legitimateDomains: ['hilton.com', 'hiltonhonors.com', 'hiltongrandvacations.com', 'hamptoninn.com'] },
    ...
    'opendoor': { keywords: ['opendoor'], legitimateDomains: ['opendoor.com'] },
    'coldwell banker': { keywords: ['coldwell banker'], legitimateDomains: ['coldwellbanker.com'] },
    'keller williams': { keywords: ['keller williams'], legitimateDomains: ['kw.com', 'kellerwilliams.com'] },
    'remax': { keywords: ['remax', 're/max'], legitimateDomains: ['remax.com'] },
    'century 21': { keywords: ['century 21', 'century21'], legitimateDomains: ['century21.com'] },
    ...
    'xiaomi': { keywords: ['xiaomi', 'mi'], legitimateDomains: ['xiaomi.com', 'mi.com'] },
    ...
    'etisalat': { keywords: ['etisalat', 'e&'], legitimateDomains: ['etisalat.ae'] },
    ...
    'noon': { keywords: ['noon.com', 'noon app', 'noon order', 'noon delivery', 'noon shopping', 'noon marketplace'], legitimateDomains: ['noon.com'] },
    ...
    'shell': { keywords: ['shell energy', 'shell gas', 'shell fuel', 'shell account', 'shell card', 'shell.com'], legitimateDomains: ['shell.com'] },
    ...
    // SWEDEN
    'hm': { keywords: ['h&m', 'hm'], legitimateDomains: ['hm.com'] },
    'ericsson': { keywords: ['ericsson'], legitimateDomains: ['ericsson.com'] },
    'telia': { keywords: ['telia'], legitimateDomains: ['telia.com', 'telia.se'] },
    // SWITZERLAND
    'nestle': { keywords: ['nestlé', 'nestle', 'nespresso', 'nescafe'], legitimateDomains: ['nestle.com', 'nespresso.com', 'nescafe.com'] },
    ...
    'next': { keywords: ['next clothing', 'next fashion', 'next.co.uk', 'next order', 'next delivery', 'next direct'], legitimateDomains: ['next.co.uk'] },
    ...
    'stellantis': { keywords: ['stellantis', 'jeep', 'chrysler', 'dodge', 'ram'], legitimateDomains: ['stellantis.com', 'jeep.com', 'chrysler.com', 'dodge.com', 'ramtrucks.com'] },
    // US FINANCIAL
    ...
    'discover financial': { keywords: ['discover card', 'discover'], legitimateDomains: ['discover.com'] },
    // US FOOD BEVERAGE
    ...
    'disney': { keywords: ['disney', 'walt disney', 'disneyland', 'disney world'], legitimateDomains: ['disney.com', 'disneyplus.com', 'go.com', 'disneyland.disney.go.com', 'disneyworld.disney.go.com', 'd23.com', 'thewaltdisneycompany.com'] },
    ...
    // US RETAIL
    'gap': { keywords: ['gap.com', 'gap store', 'gap order', 'gap factory', 'old navy', 'banana republic', 'athleta'], legitimateDomains: ['gap.com', 'oldnavy.com', 'bananarepublic.com', 'athleta.com'] },
    ...
    'dicks sporting goods': { keywords: ['dicks sporting goods', 'dick\'s sporting'], legitimateDomains: ['dickssportinggoods.com'] },
    ...
    'square': { keywords: ['square payment', 'square reader', 'square account', 'square invoice', 'squareup', 'square.com'], legitimateDomains: ['squareup.com', 'square.com'] },
    ...
    'free': {
        keywords: ['free mobile', 'free telecom', 'free.fr', 'freebox', 'free internet', 'iliad'],
...
const IMPERSONATION_TARGETS = {
    ...
    'nestlé': ['nestle.com', 'nespresso.com', 'nescafe.com'],
    'nestle': ['nestle.com', 'nespresso.com', 'nescafe.com'],
    'nespresso': ['nestle.com', 'nespresso.com', 'nescafe.com'],
    'nescafe': ['nestle.com', 'nespresso.com', 'nescafe.com'],
    ...
    'jeep': ['stellantis.com', 'jeep.com', 'chrysler.com', 'dodge.com', 'ramtrucks.com'],
    'chrysler': ['stellantis.com', 'jeep.com', 'chrysler.com', 'dodge.com', 'ramtrucks.com'],
    'dodge': ['stellantis.com', 'jeep.com', 'chrysler.com', 'dodge.com', 'ramtrucks.com'],
    'goldman sachs': ['goldmansachs.com', 'gs.com'],
    'merrill lynch': ['ml.com', 'merrilledge.com'],
    ...
    'disney': ['disney.com', 'disneyplus.com', 'go.com', 'disneyland.disney.go.com', 'disneyworld.disney.go.com', 'd23.com', 'thewaltdisneycompany.com'],
    'walt disney': ['disney.com', 'disneyplus.com', 'go.com', 'disneyland.disney.go.com', 'disneyworld.disney.go.com', 'd23.com', 'thewaltdisneycompany.com'],
    'disneyland': ['disney.com', 'disneyplus.com', 'go.com', 'disneyland.disney.go.com', 'disneyworld.disney.go.com', 'd23.com', 'thewaltdisneycompany.com'],
    'disney world': ['disney.com', 'disneyplus.com', 'go.com', 'disneyland.disney.go.com', 'disneyworld.disney.go.com', 'd23.com', 'thewaltdisneycompany.com'],
...
const KEYWORD_CATEGORIES = {
    ...
    'Urgency Tactics': {
        keywords: [
            ...
            'action required within', 'expires today',
        ...
        if (mentionsBrand) {
            ...
            if (!isLegitimate) {
                ...
                if (isESPDomain) {
                    ...
                    if (!forceEval) {
                        console.log('BRAND CHECK - ESP sender ' + senderDomain + ' mentioning ' + brandName + ' (suppressed)');
                        continue;
                    }
...
function displayLooksLikePerson(displayName) {
    ...
    if (nameWords.length >= 1 && nameWords.length <= 3) {
        ...
        if (allTitleCase || allCaps || allLower || mixedNormal) {
...
async function processEmail(emailData) {
    ...
    if (gibberishUsername && !isKnownPlatform(senderDomain)) {
        // v5.1.1: ESP-gated suppression for gibberish usernames
        // ESPs like Constant Contact generate org-style local-parts (e.g., lrll.board-laderaranchll.com)
        // that trip the consonant cluster / randomness checks. Suppress for known ESPs.
        const domLower = senderDomain ? senderDomain.toLowerCase() : '';
        const isESPSender = KNOWN_ESP_DOMAINS.some(esp => domLower === esp || domLower.endsWith('.' + esp))
            || ESP_SENDER_DOMAINS.has(domLower)
            || Array.from(ESP_SENDER_DOMAINS).some(esp => domLower.endsWith('.' + esp));
        
        if (isESPSender) {
            // ESP sender: suppress gibberish UNLESS reply-to is freemail (phishing override)
            // Viktor: "I'd use a Brevo trial with reply-to going to my gmail. Catch that."
            if (replyTo) {
                const replyToDom = (replyTo.split('@')[1] || '').toLowerCase();
                if (FREEMAIL_SET.has(replyToDom)) {
                    warnings.push({
                        type: 'gibberish-username',
                        severity: 'medium',
                        title: 'Suspicious ESP Sender',
                        description: `This email was sent through a marketing platform but replies go to a free email account (${replyToDom}). Legitimate businesses use their own domain for replies.`,
                        senderEmail: senderEmail,
                        matchedEmail: replyTo
                    });
                }
            }
            // else: ESP + no freemail reply-to → suppress gibberish (legitimate newsletter)
        } else {
            // Non-ESP: always warn on gibberish username regardless of contacts
            warnings.push({
                type: 'gibberish-username',
                severity: 'critical',
    ...
    if (replyTo && replyTo.toLowerCase() !== senderEmail) {
        ...
        if (!isReplyToSelf && replyToDomain.toLowerCase() !== senderDomain) {
            ...
            if (!isParentChild && !isSibling && !isKnownPlatform(senderDomain)) {
                ...
                if (isESPSender) {
                    ...
                    // Not an ESP → standard mismatch warning
                    warnings.push({
                        type: 'replyto-mismatch',
                        severity: 'medium',
                        title: 'Reply-To Mismatch',
    ...
    // v5.1.1: Co-occurrence urgency check for "last chance"
    // "Last chance" is a real social engineering phrase but fires too often on marketing emails.
    // Only surface it when another warning already exists (co-occurrence = real threat context).
    const contentLower = content.toLowerCase();
    if (/\blast\s+chance\b/.test(contentLower) && warnings.length > 0) {
        warnings.push({
            type: 'wire-fraud',
            severity: 'medium',
            title: 'Urgency Language Detected',
            description: 'This email uses "last chance" pressure language alongside other warning signs. False urgency is a common fraud tactic designed to prevent you from verifying details.',
            keywords: ['last chance'],
            keywordCategory: 'Urgency Tactics',
            keywordExplanation: 'False urgency is a common fraud tactic designed to prevent you from verifying details. Legitimate requests allow time to confirm.'
        });
    }
