...
const BRAND_CONTENT_DETECTION = {
    ...
    'dicks sporting goods': { keywords: ['dicks sporting goods', 'dick\'s sporting'], legitimateDomains: ['dickssportinggoods.com', 'dcsg.com'] },
...
const IMPERSONATION_TARGETS = {
    ...
    'dicks sporting goods': ['dickssportinggoods.com', 'dcsg.com'],
    'dick\'s sporting': ['dickssportinggoods.com', 'dcsg.com'],
...
function _brandBodyHasSupportingSignals(config, bodyLower, subjectLower, senderDomainLower, bodyOriginal) {
    ...
    for (const keyword of config.keywords) {
        ...
        // SIG-01: Require at least 1 live-body mention for the 3+ threshold to fire.
        // If all 3+ mentions are in quoted thread history / repeated signatures, skip.
        if (totalMentions >= 3 && liveMentions >= 1) return true;
    }
