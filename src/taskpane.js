...
async function processEmail(emailData) {
    ...
    const phishingUrgency = detectPhishingUrgency(cleanText, emailData.subject);
    if (phishingUrgency) {
        warnings.push({
    ...
    const brandImpersonation = detectBrandImpersonation(emailData.subject, cleanText, senderDomain, displayName);
