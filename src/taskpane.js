...
function detectGibberishDomain(email) {
    ...
    // v6.0.3: Raised from >3 to >=7. Short domains (4-6 chars) with no standard vowels
    // are commonly legitimate acronym/abbreviation domains (mynhd, synth, glyph).
    // 7+ chars with zero a/e/i/o/u is almost certainly gibberish infrastructure.
    // Viktor: "y" is NOT counted as a vowel — that would let me stuff y into short
    // gibberish (xyrqt, bynkz) and clear the check globally. Length gate is safer.
