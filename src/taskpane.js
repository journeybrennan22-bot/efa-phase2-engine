...
async function analyzeCurrentEmail() {
    ...
    try {
        ...
        // v6.2.0: Fetch HTML body first for QR code image extraction, then text body for analysis
        item.body.getAsync(Office.CoercionType.Html, (htmlResult) => {
            const htmlBody = (htmlResult.status === Office.AsyncResultStatus.Succeeded) ? htmlResult.value : null; // v6.2.0
